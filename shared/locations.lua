...
Config.Locations = {
    ...
    ['Luxury'] = {
        settings = {
            label = 'Luxury Autos',
            welcomeLabel = "Welcome to Luxury Autos!",
            enabled = true,
        },
        blip = {
            label = 'Luxury Autos',
        ...
        zones = {
            { coords = vector3(-1230.36, -349.06, 36.45), length = 6.0, width = 4.0, heading = 270.0, minZ = 29.88, maxZ = 33.48 },
            { coords = vector3(-1238.06, -355.28, 36.45), length = 6.0, width = 4.0, heading = 270.0, minZ = 29.88, maxZ = 33.48 },
        }
    },
    ...
    ['MRPD'] = {
        ...
        zones = {
            { coords = vector3(435.84, -975.9, 25.7), length = 9.0, width = 4.0, heading = 90.0, minZ = 24.5, maxZ = 28.5 },
            { coords = vector3(451.02, -975.59, 25.7), length = 9.0, width = 4.0, heading = 90.0, minZ = 24.5, maxZ = 28.5 },
            { coords = vector3(380.96, -1627.66, 28.77), length = 8.8, width = 4.2, heading = 340.0, minZ = 27.5, maxZ = 31.5 },
            { coords = vector3(871.9, -1350.15, 25.79), length = 9.4, width = 4.2, heading = 340.0, minZ = 27.5, maxZ = 31.5 },
        }
    },  
